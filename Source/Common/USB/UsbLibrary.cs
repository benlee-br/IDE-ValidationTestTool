...
namespace BioRad.Common.UsbDevice
{
    ...
    public class Usb
    {
        ...
        /// </summary>
        private static readonly string c_VidIdentifier = "vid_";
        /// <summary>
        /// Product id string identifier.
        /// </summary>
        private static readonly string c_PidIdentifier = "pid_";
        ...
        public static void EnumeratePorts(Usb.USBHub hub, UsbVendorId vendorId, ref List<USBDevice> devices)
        {
        ...
        /// </param>
        /// <returns></returns>
        public static List<USBDevice> GetDevices(UsbVendorId vendorId)
        {
        ...
        /// <returns></returns>
        public static List<USBDevice> GetDevices(UsbVendorId vendorId, UsbProductId productId)
        {
            List<USBDevice> devices = new List<USBDevice>();
        ...
        public static List<USBDevice> GetAllDevices()
        {
            ...
            {
                UsbVendorId vendorId = new UsbVendorId(instanceID);
        ...
        public struct DeviceInstanceId
        {
            ...
            {
                get { return new UsbVendorId(m_ID); }
            }
            /// <summary>
            /// Product ID.
            /// </summary>
            ...
            {
                get { return new UsbProductId(m_ID); }
            }
            /// <summary>
            /// Instance ID.
            /// </summary>
        ...
        public class USBDevice : ICloneable
        {
            ...
            public string DeviceInstanceID
            {
                ...
                internal set
                {
                    ...
                    m_VendorId = new UsbVendorId(m_DeviceInstanceID).ToString();
                    m_ProductId = new UsbProductId(m_DeviceInstanceID).ToString();
            ...
            /// <summary>Create a clone of the USBDevice object.</summary>
            /// <returns>The cloned USBDevice object.</returns>
            public object Clone()
            {
                USBDevice device = this.MemberwiseClone() as USBDevice;
                ...
                device.m_DevicePortNumber = this.m_DevicePortNumber;
                device.m_DeviceHubDevicePath = this.m_DeviceHubDevicePath;
                device.m_DeviceDriverKey = this.m_DeviceDriverKey;
                device.m_DeviceManufacturer = this.m_DeviceManufacturer;
                device.m_DeviceProduct = this.m_DeviceProduct;
                device.m_DeviceSerialNumber = this.m_DeviceSerialNumber;
                device.m_DeviceName = this.m_DeviceName;
                device.DeviceInstanceID = this.DeviceInstanceID;
                return device;
            }
            /// <summary>
