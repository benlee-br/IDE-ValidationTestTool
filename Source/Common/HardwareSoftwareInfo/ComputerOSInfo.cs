...
namespace BioRad.Common
{
    ...
    /// </summary>
    public static class ComputerOSInfo// CFX Manager US43 MiniOpticon will not be supported on Windows 8.1
    {
        /// <summary>
        /// Is OS windows 7?
        /// </summary>
    ...
    /// <summary>Provides detailed information about the host operating system.</summary>
	#endregion
    public static class OSInfo// TFS RA 
    {
        #region ENUMS
        /// <summary>
        /// 
        ...
        /// <param name="osMinorVersion"></param>
        /// <param name="spMajorVersion"></param>
        /// <param name="spMinorVersion"></param>
