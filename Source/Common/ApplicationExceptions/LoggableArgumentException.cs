...
namespace BioRad.Common.ApplicationExceptions
{
	...
	/// <archiveinformation>
	///		<list type="bullet">
	///			<item name="vssfile">$Workfile: LoggableArgumentException.cs $</item>
	///			<item name="vssfilepath">$Archive: /Denali3/Source/Core/Common/ApplicationExceptions/LoggableArgumentException.cs $</item>
	...
	[Serializable]
	public partial class LoggableArgumentException : LoggableApplicationException
	{
        ...
        public LoggableArgumentException(Object sender, DiagnosticSeverity ds, DiagnosticTag dt,
            string message)
		...
		protected LoggableArgumentException(SerializationInfo info, StreamingContext context): 
			base (info, context)
		{
		}
        #endregion
