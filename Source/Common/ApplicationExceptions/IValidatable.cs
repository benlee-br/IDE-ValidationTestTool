...
namespace BioRad.Common.ApplicationExceptions
{
	...
	/// <archiveinformation>
	///		<list type="bullet">
	///			<item name="vssfile">$Workfile: IValidatable.cs $</item>
	///			<item name="vssfilepath">$Archive: /Denali/Source/Core/Common/ApplicationExceptions/IValidatable.cs $</item>
	///			<item name="vssrevision">$Revision: 1 $</item>
	///			<item name="vssauthor">Last Check-in by:$Author: Shabnam $</item>
	///			<item name="vssdate">$Date: 8/11/03 11:57a $</item>
	///		</list>
	/// </archiveinformation>
	#endregion
